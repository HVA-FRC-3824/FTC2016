package org.firstinspires.ftc.teamcodepromo.hardwareDefinition;
 ...
 * Motor channel:  Intake drive motor:          "intakeMotor"
 * Motor channel:  Arm drive motor:             "armMotor"
 * Servo channel:  Servo to open left finger:   "leftFinger"
 * Servo channel:  Servo to open right finger:  "rightFinger"
 */
public class HvaHardwarePushbot
{
    ...
    public void init(HardwareMap ahwMap) {
        ...
        leftFinger = hwMap.servo.get("leftFinger");
        rightFinger = hwMap.servo.get("rightFinger");
        leftFinger.setPosition(MID_SERVO);
        rightFinger.setPosition(MID_SERVO);
    }
